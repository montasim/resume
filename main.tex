...
\section{~~Career Objective}
  ...
  \item[]
    {I want to make difference and willing to work hard for a skillful career rather than a regular career that I can be satisfied with. I want to work hard, be responsible and improve my profession and skills with a reputed organization in an ethical way to accept challenges.}
...
\section{Projects}
\resumeSubHeadingListStart
\resumeSubItem{Undergraduate Project}{Hand Keypoint Detection in Single Images using Multiview Bootstrapping.
\newline
\textbf{Tech:} Deep Learning, OpenCV, Convolutional Neural Network (CNN), Python}
